    ...
    public static void createTable() {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    if (doesExist) {
                        ...
                        javax.swing.JOptionPane.showMessageDialog(null, "The database already exsists.", 
        ...
        try {
            ...
            if (ex.getSQLState().equals("42S01") && ex.getErrorCode() == 1050)
                ...
                javax.swing.JOptionPane.showMessageDialog(null, "The table already exsists.", "Car Racing Game", 
                		javax.swing.JOptionPane.WARNING_MESSAGE);
