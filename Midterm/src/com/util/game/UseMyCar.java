 ...
 *  *     - Michael Marc
 *  * Group #: 1
 *  * Filename: com.util.game.UseMyCar
    ...
    public static void main(String[] args) {
        ...
        while (i < 60) {
            ...
            if (myFirstCar.getSpeedIncreaseStep() > 0) {
                System.out.print(myFirstCar.getSpeedIncreaseStep() + " :: " + myFirstCar
            ...
            if (mySecondCar.getSpeedIncreaseStep() > 0) {
                System.out.println(mySecondCar.getSpeedIncreaseStep() + " :: " + mySecondCar
            ...
            //if mySecondCar  speedIncreaseStep speed is zero (Constant speed)
                ...
                if (mySecondCar.getZeroCounter() % 3 == 0) {
                    ...
                    System.out.println(mySecondCar.getSpeedIncreaseStep() + " " + ":: " +
